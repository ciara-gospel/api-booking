...
import { createTimeSlot, getMyTimeSlots, getAvailableSlots, updateTimeSlot, deleteTimeSlot, publishSlots } from '../controllers/timeSlotController.js';
...
router.post('/slots/publish', authenticate, publishSlots);
